...
每日编辑流程写在 [`docs/codex-daily-curation.md`](docs/codex-daily-curation.md)：Codex 读取 GitHub、Chrome 中的 X 原帖和官方资料后判断收录，不设 stars 硬门槛。**原生 Scheduled 任务目前尚未创建**；任务说明已准备好，不能把手动试跑当作自动日更。
